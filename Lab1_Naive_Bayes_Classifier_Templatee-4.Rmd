...
test_path2  <- "data/2-fake_news/test.csv"
train_path2 <- "data/2-fake_news/train.csv"

test_path3  <- "data/3-sentiment/test.csv"
train_path3 <- "data/3-sentiment/train.csv"

test_path4  <- "data/4-spam/test.csv"
train_path4 <- "data/4-spam/train.csv"
...
```{r}
ggplot(top_words, aes(x = reorder(word, n), y = n, fill = author)) +
  geom_col(show.legend = FALSE) +
  facet_wrap(~author, scales = "free_y") +
  coord_flip() +
  labs(x = "Words", y = "Frequency", title = "Top Words by Author") +
  theme_minimal() +
...
```{r}
ggplot(top_words, aes(x = 1, y = n, label = word, size = n, color = author)) +
  geom_text(check_overlap = TRUE) +
  facet_wrap(~author, scales = "free") +
  theme_void() +
  labs(title = "Word Cloud by Author") +
